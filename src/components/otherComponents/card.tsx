...
const Card = (props: CardProps) => {
  ...
  const handlePress = () => {
    Linking.openURL(`tel:${props.phoneNumber}`); //Aca es donde se define la funcion de LinKing que es una liberia de React-Native para poder interactuar con enlaces de aplicaciones entrantes y salientes 
  };
  return (
